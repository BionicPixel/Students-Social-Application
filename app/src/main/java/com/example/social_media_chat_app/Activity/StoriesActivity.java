    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(data!=null){
            if(data.getData()!=null){
                ...
                UploadTask taskreff = reference.putFile(data.getData());
                System.out.println("TEJU$pr0");

                taskreff.addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        System.out.println("TEJU$pr0//3");
                    }
                });

                taskreff.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    @Override
